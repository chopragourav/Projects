...
<body>
  <table>
    ...
    <hr class="new1">
  <center><h6>Note: Institution doesn't own for the errors or permissions, if any, in this statement.
Designed & Developed by Gourav Chopra</h6></center>
  <hr class="new1">
<center><h6>Copyright © 2021 LNCT | Powered by LNCT Group</h6></center> 
  <hr class="new1">
</body>
<%}
else{
